...
<@s.form action="${ctx}admin/paravalue/update.action" method="post" id="updateForm">
	<table width="100%" cellpadding="0" cellspacing="2" class="edittab">
		<tr><td><h2>[${(parach.ch_name)?if_exists}]系统参数值修改</h2></td></tr>
		...
		<tr><td>
			...
			<@s.hidden name="paravalue.val_id" />
